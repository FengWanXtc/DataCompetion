...
function cpiall() {
  var option = {
    ...
    legend: {
      color: ["#FFB6C1", "#4B0082", "	#FF0000", "#00FF7F", "#FFD700", "#BA55D3", "	#0000FF", "#000000"],
      data: [{
        name: '食品烟酒类',
        textStyle: {
          color: "#FFB6C1",
    ...
    series: [{
      name: '食品烟酒类',
      type: 'line',
      data: [61, 67, 73, 84, 114, 139, 129, 152, 160, 136, 113, 85],
      color: "#FFB6C1",
      lineStyle: {
        normal: {
          width: 4,
      ...
      name: '衣着类',
      type: 'line',
      data: [18, 18, 16, 16, 12, 11, 8, 6, 5, 7, 6, 6],
      lineStyle: {
        normal: {
          width: 4,
          color: {
      ...
      name: '生活用品及服务类',
      type: 'line',
      data: [8, 8, 7, 6, 6, 6, 4, 4, 2, 1, 3, 1, 1],
      lineStyle: {
        normal: {
          width: 4,
          color: {
